...
<small>For a deep dive through *all* the features of React, check out my new course <b><a href="https://understandingreact.com?coupon_code=COMPILER">Understanding React</a></b> where we dig into React's source code. <a href="https://understandingreact.com?coupon_code=COMPILER">It's 33% off today (June 24) only!</a></small>
