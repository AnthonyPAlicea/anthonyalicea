...
title: "Don't Imitate Understand - #8"
desc: "The Spec → Plan → Decompose → Implement → Review Loop"
tags: ['newsletter']
number: 8
...
- I am very pleased to announce that I am writing a book in public, and I'm making it available to read for free online. The first 9 chapters are available right now! The book is called [Cascade Methodology: Software Development Practices for the Age of AI](https://dontimitate.dev/cascade/).
  ...
  So please [give these first chapters a read](https://dontimitate.dev/cascade/)! My email is open and I welcome any thoughts, as I will edit the book based on reader feedback.
- New modules are coming to my new [Modern JavaScript Frameworks course](https://dontimitate.dev/courses/javascript-frameworks/) and [AI-assisted development course](https://dontimitate.dev/courses/ai-assisted-development/). You can still grab at the early-access price which ends in February, either for yourself or for your entire team.
...
**Decompose**: Take that plan and decompose it into _human-reviewable_ smaller tasks. The biggest mistake is to ask the LLM to produce more code than you can comfortably review at a time.
...
1. _Good context_: the spec, the decomposed plans, and any other information you would need to build it yourself.
2. _Good example code_: documentation (maybe via MCP), sample usages in the codebase, hand-built components for the LLM to use as a pattern to follow all do wonders.

How much faster will it make you? It depends on a lot of factors, especially how complex the code is that you have to review. But you _should_ review LLM code before you make a PR.
...
- [Techniques for getting structured outputs out of LLMs](https://nanonets.com/cookbooks/structured-llm-outputs)
- Vercel is providing [React Best Practices](https://vercel.com/blog/introducing-react-best-practices) that you can add as a skill to your LLM.
- Speaking of LLM agent skills, here's [the Agent Skills open standard](https://agentskills.io/).
- A long form post on [how to write good specs](https://addyosmani.com/blog/good-spec/) for AI agents.
